...
public class Conexion_IP_memoria extends AsyncTask<Void,Void,String> {
    ...
    public Conexion_IP_memoria(String Ip, int Puerto, String msg, Context contexto, Lay_EnviarDatos ac) {
